    ...
    if (mobile) {
        return (
            <div className={classes.mobileWrapper}>
                <IconBtn icon={GitHub} m={1} href="https://github.com/adeoye00" />
                <IconBtn icon={Instagram} m={1} href="https://www.instagram.com/creamybutterycakes/lin/" />
                <IconBtn icon={LinkedIn} m={1} href="https://www.linkedin.com/in/ade-adeagbo-14657963/" />
                <IconBtn icon={Email} m={1} href="mailto:Adeoye00@gmail.com" />
            </div>
        );
    } else {
        return (
